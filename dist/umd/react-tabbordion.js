...
function r(e){return(r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function i(e){return(i="function"==typeof Symbol&&"symbol"===r(Symbol.iterator)?function(e){return r(e)}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":r(e)})(e)}Object.defineProperty(t,"__esModule",{value:!0}),t.getArray=function(e){return Array.isArray(e)&&0<e.length?e:o},t.getChecked=function(e){return e.checked},t.getDisabled=function(e){return e.disabled},t.getEnabled=function(e){return!e.disabled},t.getIndex=function(e){return e.index},t.isShallowlyDifferent=a,t.isShallowlyDifferentArray=l
var o=[]
...
var o,h=function(e){if(e&&e.__esModule)return e
var t=l()
...
return n}(n(1)),i=(o=n(2))&&o.__esModule?o:{default:o},a=n(3),m=n(4)
...
return e}function p(e,t){return(p=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}var y=0,g=0
function v(e){return{bemModifiers:e.bemModifiers,bemSeparator:e.bemSeparator,blockElements:e.blockElements}}function O(e,t,n){var r=(0,m.getArray)(n.stateful?n.panels:t.panels)
return{animateContent:t.animateContent,checkedPanels:r.filter(m.getChecked).filter(m.getEnabled).map(m.getIndex),disabledPanels:r.filter(m.getDisabled).map(m.getIndex),firstVisiblePanel:e.firstVisibleIndex,lastVisiblePanel:e.lastVisibleIndex,firstSelectableIndex:e.firstSelectableIndex,panelName:t.name||e.uniqId,panelType:"multiple"===t.mode?"checkbox":"radio",tabbordionId:t.id||e.uniqId}}function P(e){return e}var S=function(){function n(e){var t
return function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,n),t=function(e,t){return!t||"object"!==u(t)&&"function"!=typeof t?d(e):t}(this,b(n).call(this,e)),y++,t.uniqId="tabbordion-".concat(g),g++,t.getNextState=t.getNextState.bind(d(t)),t.onChange=t.onChange.bind(d(t)),t.firstVisibleIndex=null,t.lastVisibleIndex=null,t.firstSelectableIndex=null,t.state=t.getNextState(e,{stateful:!1},Array.isArray(e.panels)?e.panels:e.initialPanels),t.subscribers={bem:[],tabbordion:[]},t.childContext={bem:{getState:function(){return t.bemState},subscribe:(0,a.addSubscriber)(t.subscribers.bem),unsubscribe:(0,a.removeSubscriber)(t.subscribers.bem)},tabbordion:{getState:function(){return t.tabbordionState},onChangePanel:t.onChange,subscribe:(0,a.addSubscriber)(t.subscribers.tabbordion),unsubscribe:(0,a.removeSubscriber)(t.subscribers.tabbordion)}},t.bemState=v(e),t.tabbordionState=O(d(t),e,t.state),t}return function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function")
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&p(e,t)}(n,h.PureComponent),function(e,t,n){t&&f(e.prototype,t),n&&f(e,n)}(n,[{key:"UNSAFE_componentWillReceiveProps",value:function(e){var t=this.getNextState(e,this.state)
t!==this.state&&this.setState(t)
var n=v(e);(0,m.isShallowlyDifferent)(n,this.bemState)&&(this.subscribers.bem.forEach(function(e){return e.forceUpdate()}),this.bemState=n)
var r=O(this,e,t);(0,m.isShallowlyDifferent)(r,this.tabbordionState)&&(this.subscribers.tabbordion.forEach(function(e){return e.forceUpdate()}),this.tabbordionState=r)}},{key:"componentWillUnmount",value:function(){0===--y&&(g=0)}},{key:"getChildContext",value:function(){return this.childContext}},{key:"getNextState",value:function(e,t,n){for(var a=(0,m.getArray)(t.stateful?t.panels:n||e.panels),o=[],i=[],l=[],u="multiple"===e.mode,c=[e.children];c.length;)h.Children.forEach(c.shift(),function(e){if(null!=e&&e.type){var t=e.props||e._store&&e._store.props||{}
if(e.type===h.default.Fragment&&t.children)c.push(t.children)
...
o[l.shift()].index=r,r++}var s=0,f=null,b=null,d=null,p=o.map(function(t,e){var n=a.find(function(e){return e.index===t.index})||{checked:o,disabled:r,visible:i},r=null!=t.disabled?t.disabled:!!n.disabled,o=!r&&(null!=t.checked?t.checked:!!n.checked)&&(u||0===s),i=null!=t.visible?t.visible:!1!==n.visible
return i&&(b=e,r||null!=d||(d=b),null==f&&(f=b)),o&&i&&s++,{checked:o,disabled:r,index:t.index,visible:i}})
null!=d&&(0===s&&"multiple"!==e.mode&&"toggle"!==e.mode&&(p[d].checked=!0),f=p[f].index,b=p[b].index,d=p[d].index),this.firstVisibleIndex=f,this.lastVisibleIndex=b,this.firstSelectableIndex=d
var y=!e.onChange||!e.onPanels||!Array.isArray(e.panels)
if(y){if(!t.stateful||(0,m.isShallowlyDifferentArray)(t.panels,p))return e.onPanels&&e.onPanels(p),{panels:p,stateful:y}}else if((0,m.isShallowlyDifferentArray)(a,p)&&e.onPanels(p),t.stateful)return{panels:null,stateful:y}
...
break
default:this.state.panels.forEach(function(e){e!==n&&e.checked&&(e.checked=!1,r=!0)}),n.checked||(n.checked=!0,r=!0)}r&&this.setState({panels:this.state.panels.slice(0)})}else this.props.onChange({index:t,mode:e})}},{key:"render",value:function(){for(var e=this.props,t=(e.animateContent,e.children),n=e.component,r=(e.bemModifiers,e.bemSeparator,e.blockElements,e.component,e.initialPanels,e.mode,e.name,e.onChange,e.onPanels,e.panels),o=s(e,["animateContent","children","component","bemModifiers","bemSeparator","blockElements","component","initialPanels","mode","name","onChange","onPanels","panels"]),i=0,a=this.state.stateful?this.state.panels:r,l=[t],u=[];l.length;)h.Children.forEach(l.shift(),function(e){if(null!=e&&e.type)if(e.type===h.default.Fragment)l.push(e.props.children)
else if(e.type.contextTypes&&e.type.contextTypes.tabbordion){var t=h.default.cloneElement(e,a[i])
i++,u.push(t)}else u.push(e)
else u.push(e)})
return h.default.createElement(n,c({},o,{role:"tablist"}),h.Children.map(u,P))}}]),n}()
S.childContextTypes={bem:i.default.object,tabbordion:i.default.object},S.defaultProps={animateContent:!1,bemModifiers:{animated:"animated",between:"between",checked:"checked",content:"content",disabled:"disabled",enabled:"enabled",first:"first",hidden:"hidden",last:"last",noContent:"no-content",unchecked:"unchecked"},bemSeparator:"--",blockElements:{animator:"panel__animator",content:"panel__content",label:"panel__label",panel:"panel"},component:"ul",mode:"single"},S.propTypes={animateContent:i.default.oneOf([!1,"height","marginTop"]),bemModifiers:i.default.shape({between:i.default.string,checked:i.default.string,content:i.default.string,disabled:i.default.string,enabled:i.default.string,first:i.default.string,hidden:i.default.string,last:i.default.string,noContent:i.default.string,unchecked:i.default.string}),bemSeparator:i.default.string,blockElements:i.default.shape({content:i.default.string,label:i.default.string,panel:i.default.string}),children:i.default.node,className:i.default.string,component:i.default.oneOfType([i.default.func,i.default.object,i.default.string]),id:i.default.string,initialPanels:i.default.arrayOf(i.default.shape({checked:i.default.bool,disabled:i.default.bool,index:i.default.number,visible:i.default.bool})),mode:i.default.oneOf(["single","toggle","multiple"]),name:i.default.string,onChange:i.default.func,onPanels:i.default.func,panels:i.default.arrayOf(i.default.shape({checked:i.default.bool,disabled:i.default.bool,index:i.default.number,visible:i.default.bool}))}
var j=S
...
g.childContextTypes={tabbordionPanel:i.default.object},g.contextTypes={bem:i.default.object,tabbordion:i.default.object},g.defaultProps={component:"li"},g.propTypes={checked:i.default.bool,className:i.default.string,disabled:i.default.bool,id:i.default.string,index:i.default.number,name:i.default.string,type:i.default.oneOf(["checkbox","radio"]),value:i.default.string,visible:i.default.bool,children:i.default.node,component:i.default.oneOfType([i.default.func,i.default.object,i.default.string]),modifiers:i.default.array}
var v=g
